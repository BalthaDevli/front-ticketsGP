...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      >
        <source
          src="https://penna-public.s3.amazonaws.com/luzneonmoveFinal.mp4"
          type="video/mp4"
        />
      ...
      <div className="flex flex-col rounded-lg bg-black/30 overflow-hidden">
        <div className="relative flex flex-row w-full h-32">
          ...
          <p className="absolute -bottom-2 w-full px-auto pb-3 bg-black/30 text-center text-3xl font-roboto-thin text-blue-400">
            movemos <span className="text-[#92BB42]">energía</span>
          </p>
        </div>
